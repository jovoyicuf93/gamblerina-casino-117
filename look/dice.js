...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-32be0c88');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-32be0c88');}
...
function clearFlash(){dieView.classList.remove('rl-win-32be0c88');dieView.classList.remove('rl-lose-32be0c88');if(frameEl){frameEl.classList.remove('rl-win-32be0c88');frameEl.classList.remove('rl-lose-32be0c88');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-32be0c88');if(frameEl){frameEl.classList.add('rl-win-32be0c88');}}else{dieView.classList.add('rl-lose-32be0c88');if(frameEl){frameEl.classList.add('rl-lose-32be0c88');}}
...
var brandEl=document.querySelector('.rl-brand-32be0c88');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
